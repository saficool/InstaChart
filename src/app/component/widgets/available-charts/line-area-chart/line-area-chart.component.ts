...
export class LineAreaChartComponent {
  ...
  protected async saveChartConfiguration() {
    ...
    await this.chartSeriesDataPreparationService.lineAreaChartSeriesData(this.chartConfiguration.data_object! as ILineDataObject, this.chartData.chart_data, new AggregateFunctionsService)
      .then((data: any) => {
