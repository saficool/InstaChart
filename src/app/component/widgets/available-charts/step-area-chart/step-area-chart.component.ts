...
export class StepAreaChartComponent {
  ...
  protected async saveChartConfiguration() {
    ...
    await this.chartSeriesDataPreparationService.stepAreaChartSeriesData(this.chartConfiguration.data_object! as ILineDataObject, this.chartData.chart_data, new AggregateFunctionsService)
      .then((data: any) => {
